...
import static com.example.campusconcert.domain.festival.entity.QFestivalTime.festivalTime;
import static com.example.campusconcert.domain.festival.entity.QTicketInfo.ticketInfo;
...
public class TicketInfoRepositoryImpl implements TicketInfoRepositoryCustom {
    ...
    public Page<TicketResponseDTO> getTickets(PageRequestDTO requestDTO) {
        ...
        List<TicketResponseDTO> dtoList = jpaQueryFactory
                ...
                .leftJoin(festivalTime).on(ticketInfo.festivalId.eq(festivalTime.id)).fetchJoin()
